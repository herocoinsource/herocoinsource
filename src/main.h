...
static const int64 MAX_MINT_PROOF_OF_WORK = 60 * COIN;
...
static const uint256 hashGenesisBlockOfficial("0x2a71cf2736cf5f9c10ce849dfef06fa69c2ae7a8eccebb65c6383367a417ba6f");
...
// herocoin: calculate Nfactor using timestamp
...
public:
    ...
    {
        // Protocol switch to support p2pool at herocoin block #9689
        //if (nHeight >= 9689)
        {
        ...
        /*// Before herocoin block #9689 - old protocol

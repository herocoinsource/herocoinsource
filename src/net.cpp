...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "HeroCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"herocoin.ie1.cn", "seeds.herocoin.ie1.cn"},
    {"herocoin.ie1.cn", "seed1.herocoin.ie1.cn"},
    {"herocoin.ie1.cn", "seed2.herocoin.ie1.cn"},
    {"herocoin.ie1.cn", "tnseeds.herocoin.ie1.cn"}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. HeroCoin is probably already running."), addrBind.ToString().c_str());
        else
